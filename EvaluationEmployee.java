...
/**
 * This class contains three methods by which classes
 * EvaluationMarketingEmployees, EvaluationAccountingEmployees,
 * EvaluationItEmployees and EvaluationHrEmployees(they are in the same package)
 * perform their job. In particular it consists of the following methods:
 * questionMenu, mainMethod, degrees and semester.
 * 
...
public class EvaluationEmployee {
	...
	/**
	 * 
	 * Performs the evaluation questionnaire.
	 * 
	 ...
	 * @param id     contains the ID of the employee being evaluated.
	 ...
	 * Retrieves scores.
	 * 
	 * @param id        contains the ID of a particular employee for whom we
	 *                  retrieve his/her scores.
	 * @param semesters contains the semesters for which we retrieve his/her scores.
	 * @param array1    contains the ID of the employees of a department and is
	 *                  parallel to the array list array2.
	 * @param array2    contains the scores of employees of a department for all
	 *                  their semesters.
	 * @return returns the grades of those particular semesters.
	 */
	 ...
	 *               parallel to the array list array2.
	 * @param count1 indicates whether it is the first semester of grades or not.
	 */
