...
public class CreatingFiles {
	...
	public static void main(String args[]) {
		...
		degreespersemester1.add(new ArrayList<Double>());
		degreespersemester1.get(0).add(0, 3.2);
		degreespersemester1.get(0).add(1, 4.9);
		degreespersemester1.get(0).add(2, 4.8);
		...
		idpermarketingemployee.add(0, 12564789.0);
		/**
