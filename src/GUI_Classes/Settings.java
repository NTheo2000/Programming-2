...
/**
 * Changes the username or the password
...
/**
 * Changes the user name or the password
					...
					enterButton.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							...
							if (!(cred.toString()).equals(confirmcred.toString())) {
								...
								frame.validate();
							} else if (usernameOrPassword.equals("username")
									&& !WorkersDatabase.isUsernameUnique(cred.toString())) {
								...
								try {
									WorkersDatabase.changeUsernameorPassword(employee, usernameOrPassword,
											cred.toString());
									newCredentialPane.setVisible(false);
