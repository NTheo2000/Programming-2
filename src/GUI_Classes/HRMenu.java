...
public class HRMenu extends LoginMenu {
	 ...
	 */
	public HRMenu(String name, JFrame frame, Employee employee) {
		this.frame = frame;
		this.firstname = name;
	...
	/**
	 * initialize and create the frame for the menu
	 */
	public void initialize() {
		...
		ev_candButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				new EvCandMenu(firstname, frame, employee);
			}
		});
